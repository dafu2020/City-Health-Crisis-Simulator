...
def print_outbreak_data(outbreak_data_dictionary: dict) -> None:
    ...
    for date, case_number in outbreak_data_dictionary.items():
        print(f'On day {date}, we have {case_number} confirmed cases of COVID-19')
    time.sleep(2)
    print(f'\nThe time has come for all of us to do more; you must stay at home. \n'
          f'This is the critical thing we must do to stop the disease spreading. \n'
          f'Please only leave your house when necessary and for very limited purposes.\n'
          f'Please respect the work of our medical staff. Together, we can flatten the curve!\n')
